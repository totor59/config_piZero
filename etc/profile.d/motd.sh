...
header="$header$borderBar$(color $headerLeafColor "         '. \ ' ' / .'                                                        ")$borderBar\n"
header="$header$borderBar$(color $headerRaspberryColor "          .~ .~~~..~.                _ _____                                  ")$borderBar\n"
header="$header$borderBar$(color $headerRaspberryColor "         : .~.'~'.~. :         _ __ (_) _  / ___ _ __ ___                     ")$borderBar\n"
header="$header$borderBar$(color $headerRaspberryColor "        ~ (   ) (   ) ~       | '_ \| \// / / _ \ '__/ _ \                    ")$borderBar\n"
header="$header$borderBar$(color $headerRaspberryColor "       ( : '~'.~.'~' : )      | |_) | |/ //\  __/ | | (_) |                   ")$borderBar\n"
header="$header$borderBar$(color $headerRaspberryColor "        ~ .~ (   ) ~. ~       | .__/|_/____/\___|_|  \___/                    ")$borderBar\n"
...
localip="$(ifconfig usb0 | grep "inet addr" | cut -d: -f2 | awk '{ print $1}')"
...
label6="$(extend "$localip")"
label6="$borderBar  $(color $statsLabelColor "Local IP......:") $label6$borderBar"

label7="$(extend "$publicip")"
label7="$borderBar  $(color $statsLabelColor "Public IP.....:") $label7$borderBar"
